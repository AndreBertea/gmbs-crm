...
- Ouvrir `/previews/interventions-card` et vérifier 6 états: default, hover, focus, due-soon, overdue, blocked
- Exécuter `pnpm test:e2e` pour générer le screenshot de référence (Playwright)
