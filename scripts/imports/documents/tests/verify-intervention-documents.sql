...
SELECT 
  ...
  COUNT(*) FILTER (WHERE kind = 'a classifier') as documents_a_classifier,
  COUNT(*) FILTER (WHERE kind != 'a classifier') as documents_classifies
...
-- 3. Documents "à classifier" par intervention
SELECT 
  i.id_inter,
...
SELECT 
  ...
  COUNT(*) FILTER (WHERE ia.kind = 'a classifier') as nb_a_classifier,
  COUNT(*) FILTER (WHERE ia.kind != 'a classifier') as nb_classifies,
...
-- 12. Top 10 des interventions avec le plus de documents "à classifier"
SELECT 
  i.id_inter,
